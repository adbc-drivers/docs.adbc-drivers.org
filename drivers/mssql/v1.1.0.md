...
(driver-mssql-v1.1.0)=
# Microsoft SQL Server Driver v1.1.0

:::{note}
This project is not associated with Microsoft.
:::

[{badge-primary}`Driver Version|v1.1.0`](#driver-mssql-v1.1.0 "Permalink") {badge-secondary}`Release Date|2026-01-07` {badge-success}`Tested With|Microsoft SQL Server 2022`
