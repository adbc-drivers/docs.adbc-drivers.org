...
(driver-mssql-v1.3.0)=
# Microsoft SQL Server Driver v1.3.0

:::{note}
This project is not associated with Microsoft.
:::

[{badge-primary}`Driver Version|v1.3.0`](#driver-mssql-v1.3.0 "Permalink") {badge-secondary}`Release Date|2026-02-19` {badge-success}`Tested With|Microsoft SQL Server 2022`
