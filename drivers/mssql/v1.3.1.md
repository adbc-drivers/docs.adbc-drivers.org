...
(driver-mssql-v1.3.1)=
# Microsoft SQL Server Driver v1.3.1

:::{note}
This project is not associated with Microsoft.
:::

[{badge-primary}`Driver Version|v1.3.1`](#driver-mssql-v1.3.1 "Permalink") {badge-secondary}`Release Date|2026-03-11` {badge-success}`Tested With|Microsoft SQL Server 2025`
