...
(driver-mssql-v1.4.0)=
# Microsoft SQL Server Driver v1.4.0

:::{note}
This project is not associated with Microsoft.
:::

[{badge-primary}`Driver Version|v1.4.0`](#driver-mssql-v1.4.0 "Permalink") {badge-secondary}`Release Date|2026-05-19` {badge-success}`Tested With|Microsoft SQL Server 2025`
...
- Microsoft SQL Server `17.0.4040.1 Enterprise Evaluation Edition (64-bit)`
