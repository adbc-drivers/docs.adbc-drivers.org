...
(driver-redshift-v1.2.1)=
# Amazon Redshift Driver v1.2.1

[{badge-primary}`Driver Version|v1.2.1`](#driver-redshift-v1.2.1 "Permalink") {badge-secondary}`Release Date|2026-03-11` {badge-success}`Tested With|Amazon Redshift aws`
