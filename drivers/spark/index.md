...
[{badge-primary}`Driver Version|v0.1.0-alpha.2`](#driver-spark-v0.1.0-alpha.2 "Permalink") {badge-secondary}`Release Date|2026-06-02` {badge-success}`Tested With|Spark 3.x 3.5-livy` {badge-success}`Tested With|Spark 3.x 3.5-thrift` {badge-success}`Tested With|Spark 4.x 4.0-connect` {badge-success}`Tested With|Spark 4.x 4.0-thrift` {badge-success}`Tested With|Spark 4.x 4.0-thrifthttp`
